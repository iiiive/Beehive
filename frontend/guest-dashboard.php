...
<div id="history-log" class="container">
  <div class="card">
    ...
    <div class="<?php echo ($latestTemp>36||$latestTemp<32)?'status-bad':'status-good';?>" id="temp-status">
  ...
  <div class="card">
    ...
    <div class="<?php echo ($latestHum>40&&$latestHum<=55)?'status-good':'status-bad';?>" id="hum-status">
