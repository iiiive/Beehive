...
<div id="history-log" class="container">
  <div class="card">
    ...
    <div class="<?php echo ($latestTemp>25.90||$latestTemp<22.30)?'status-bad':'status-good';?>" id="temp-status">
  ...
  <div class="card">
    ...
    <div class="<?php echo ($latestHum>79.20&&$latestHum<=86.40)?'status-good':'status-bad';?>" id="hum-status">
