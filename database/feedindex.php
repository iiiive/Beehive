        ...
        <div class="d-flex flex-wrap gap-2 mb-3 align-items-center">
          <form method="get" class="d-flex flex-wrap gap-2 align-items-center">
            <div class="group">
              ...
              <input class="input" type="search" placeholder="Search..." name="search" id="query"/>
            </div>
            <button type="submit" class="btn"><i class="bi bi-search"></i> Search</button>
            <a href="index.php" class="btn"><i class="bi bi-arrow-counterclockwise"></i> Reset</a>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                ...
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="?filter=fanOn">Exhaust Fan: ON</a></li>
                <li><a class="dropdown-item" href="?filter=fanOff">Exhaust Fan: OFF</a></li>
                <li><a class="dropdown-item" href="?filter=mistOn">Mist: ON</a></li>
                <li><a class="dropdown-item" href="?filter=mistOff">Mist: OFF</a></li>
                <li><a class="dropdown-item" href="?filter=heaterOn">Heater: ON</a></li>
                <li><a class="dropdown-item" href="?filter=heaterOff">Heater: OFF</a></li>
              </ul>
            </div>
      ...
      json.data.forEach(row => {
        tbody.innerHTML += `
          <tr>
            ...
            <td>${row.status}</td>
            <td><a href="read.php?reading_id=${row.reading_id}" class="cta"><i class="bi bi-eye-fill"></i></a></td>
          </tr>
        `;
      });
    }
